LNLS Ansible Role Desktop Settings
=======================

This Ansible role configures Desktop settings  for Sirius Light Source control machines.
...
```bash
    bash -c "\
        ...
        cd lnls-ans-role-desktop-settings && \
